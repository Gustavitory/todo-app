...
import {
  statusColor,
  gradeColor,
} from "../../../Organisms/Cards/PrincipalCards/PrincipalCard";
...
export function ModalTaskResume({
  controller,
  state,
  task,
              ...
              <div className="subInfoCont">
                <div>
                  ...
                  <div className="infoClock">
                    {current.min}
                    <span>min</span> {current.seg} <span>seg</span> /{" "}
                    {limit.min}
                    <span>min</span> {limit.seg} <span>seg</span>
                  </div>
                </div>
                <div
                  className="statusCont"
                  style={
                    { "--sta": `var(${statusColor(status)})` } as statusColor
                  }
                >
                  {status}
                </div>
